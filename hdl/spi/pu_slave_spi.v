...
// FIXME: attr_in and attr_out

//                             ----------------------\
//                             signal_oe & signal_wr |
//                                                   |                /------------------\
//                                                   V    i2n_action  |       buffer_sel |        signal_oe  /-\
//                             /-------------------->*--------------->|  +------------+  |      ------------>| |  data_out
//                             | i2n_splitter_ready                   |  | i2n_buf[0] |  |                   | |----------->
//                             |                        i2n_buf_mode  |  +------------+  |------------------>| |
//                           +--------------+           ------------->|  +------------+  |  i2n_buf_data_out \-/
//           /-------------->| i2n_splitter |------------------------>|  | i2n_buf[1] |  |
//           | spi_ready     +--------------+  i2n_splitter_data_out  |  +------------+  |
//           | i2n_splitter_from_spi                                  \------------------/
//           |
//        +------------+
// ------>| spi_driver |
//  miso  +------------+
...
//  sclk     |                                                        |       buffer_sel |<-------------
//    cs     |                                                        |  +------------+  |
//           |               +--------------+                         |  | n2i_buf[0] |  |  n2i_action
//           \---------------| n2i_splitter |<------------------------|  +------------+  |<-------------*<-----------------------
//             spi_prepare   +--------------+   n2i_buf_data_out      |  +------------+  |              ^  signal_wr & !signal_oe
//             n2i_splitter_data_out   |                              |  | n2i_buf[1] |  |  data_in     |
//                                     |                              |  +------------+  |<--------     |
//                                     |                              \------------------/              |
//                                     | n2i_splitter_ready                                             |
//                                     \----------------------------------------------------------------/
...
assign attr_out = {ATTR_WIDTH{1'b0}};
