...
tests = testGroup "Broken PU and negative tests"
    ...
    , testGroup "working with attributes"
        ...
        , puCoSimTestCase "invalid value" u2
            [("a", Attr{ value=42, invalid=True })] [ brokenReg "a" ["b"] ]
        , expectFail $ puCoSimTestCase "invalid value with broken attr" u2{ wrongAttr=True }
            [("a", Attr{ value=42, invalid=True })] [ brokenReg "a" ["b"] ]
        ]
