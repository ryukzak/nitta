...
basic :: (FixedPointCompatible x, Val x) => Proxy x -> BusNetwork T.Text T.Text x Int
...
maBroken :: (FixedPointCompatible x, Val x) => Broken T.Text x Int -> BusNetwork T.Text T.Text x Int
