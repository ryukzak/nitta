...
export class SynthesisGraph extends React.Component<SynthesisGraphProps, SynthesisGraphState> {
  ...
  componentWillReceiveProps (props: SynthesisGraphProps) {
    ...
    haskellAPI.getSynthesis()
      .then((response: any) => {
        ...
        let buildGraph = (gNode: any, dNode: any) => {
          ...
          dNode[0].svCntx.forEach((e: any, i: any) => {
