...
### Testing algorithm synthesis evaluation
...
examples using
```bash
python3 ml/synthesis/src/scripts/evaluation.py examples/fibonacci.lua examples/counter.lua --nitta_args="--format=csv"
