...
microarch = busNetwork 31
  ...
  , ("div", PU (def :: D.Div String Int (TaggedTime String Int)){ D.state=D.DivSt True, D.pipeLine=8 } D.PUPorts{ D.wr=Signal 27, D.wrSel=Signal 28, D.oe=Signal 29, D.oeSel=Signal 30 } )
  ]
