...
data FramInput io v = FramInput Int (O io) deriving ( Typeable )
...
instance IOType io v => FunctionalBlock (FramInput io v) v where
  ...
  isCritical _ = True
instance FunctionSimulation (FramInput (Parcel v) v) v Int where
  simulate = error "Can't functional simulate FramInput!"



data FramOutput io v = FramOutput Int (I io) deriving ( Typeable )
...
instance IOType io v => FunctionalBlock (FramOutput io v) v where
  ...
  isCritical _ = True
instance FunctionSimulation (FramOutput (Parcel v) v) v Int where
  simulate = error "Can't functional simulate FramOutput!"



data Reg io v = Reg (I io) (O io) deriving ( Typeable )
...
instance ( Ord v ) => FunctionSimulation (Reg (Parcel v) v) v Int where
...
data Add io v = Add (I io) (I io) (O io) deriving ( Typeable )
...
instance ( Ord v ) => FunctionSimulation (Add (Parcel v) v) v Int where
...
data Constant io v = Constant Int (O io) deriving ( Typeable )
...
instance ( Ord v ) => FunctionSimulation (Constant (Parcel v) v) v Int where
  simulate cntx step (Constant x (O as))
    = out cntx step as x



data ShiftL io v = ShiftL (I io) (O io) deriving ( Typeable )
...
instance ( Ord v ) => FunctionSimulation (ShiftL (Parcel v) v) v Int where
