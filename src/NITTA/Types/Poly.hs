...
--
-- - Описание варианта (Option) и решения (Decision) должны специализироваться по типам.
--   Есть три способа это обеспечить: 1) Определить необходимый kind для Option и Decision, а их
