...
instance ( Ord v ) => Patch (Reg v x) v where
    patch v v' (Reg a b) = Reg (patch v v' a) (patch v v' b)
...
instance ( Ord v ) => Patch (Add v x) v where
    patch v v' (Add a b c) = Add (patch v v' a) (patch v v' b) (patch v v' c)
...
instance ( Ord v ) => Patch (Sub v x) v where
    patch v v' (Sub a b c) = Sub (patch v v' a) (patch v v' b) (patch v v' c)
...
instance ( Ord v ) => Patch (Multiply v x) v where
    patch v v' (Multiply a b c) = Multiply (patch v v' a) (patch v v' b) (patch v v' c)
...
instance ( Ord v ) => Patch (Division v x) v where
    patch v v' (Division a b c d) = Division (patch v v' a) (patch v v' b) (patch v v' c) (patch v v' d)
...
instance ( Ord v ) => Patch (Constant v x) v where
    patch v v' (Constant x a) = Constant x (patch v v' a)
...
instance ( Ord v ) => Patch (ShiftLR v x) v where
    patch v v' (ShiftL a b) = ShiftL (patch v v' a) (patch v v' b)
    patch v v' (ShiftR a b) = ShiftR (patch v v' a) (patch v v' b)
...
instance ( Ord v ) => Patch (Send v x) v where
    patch v v' (Send a) = Send (patch v v' a)
